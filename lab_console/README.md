...
Раздел `/ui/v0473-validations` содержит 37 русскоязычных представлений завершённой проверки v0.4.7.3. Локальный API использует строгий allow-list переходов, сохраняет состояние и аудит, но не предоставляет регистрацию, активацию, продвижение, изменение порога, переобучение, загрузку или произвольную команду. Автономная проверка: `python -m tools.lab_console.verify_v0473`.
