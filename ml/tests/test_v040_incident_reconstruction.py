...
def test_parallel_track_does_not_replace_mainline() -> None:
    ...
    assert status["latest_completed_stage"] in {"v0.4.0", "v0.4.1", "v0.4.2", "v0.4.3", "v0.4.4", "v0.4.5", "v0.4.6", "v0.4.7"}
    assert status["mainline_next_allowed_stage"] == "v0.3.19"
    assert status["allowed_next_stage"] in {"v0.4.1", "v0.4.2", "v0.4.3", "v0.4.4", "v0.4.5", "v0.4.6", "v0.4.7", "independent_human_review_required"}
