...
class TestResearchState(unittest.TestCase):
    def test_authoritative_state_is_safe_and_current(self):
        ...
        self.assertEqual(state["current_completed_stage"], "v0.3.17")
        ...
        self.assertEqual(state["next_allowed_stage"], "v0.3.17.1")
        ...
        self.assertEqual(state["blocked_stage"], "v0.3.18")
        self.assertFalse(state["candidate_ready_for_v0_3_18_external_review_and_trial_design"])
