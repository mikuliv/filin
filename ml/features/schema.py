...
# v0.3 is historical: its declared profile is intentionally preserved.  The
# v0.4 profile is the only source of model columns for the future redesign.
NETWORK_SENSOR_V0_4 = [
    "flow_count", "tcp_flow_count", "udp_flow_count", "icmp_flow_count",
    "unique_destination_ip_count", "unique_destination_port_count", "unique_service_count",
    "flow_duration_mean", "flow_duration_median", "flow_duration_std", "flow_duration_p95", "flow_duration_max",
    "orig_bytes_total", "resp_bytes_total", "total_bytes", "orig_bytes_mean", "resp_bytes_mean", "orig_resp_bytes_ratio",
    "orig_packets_total", "resp_packets_total", "total_packets", "orig_packets_mean", "resp_packets_mean", "orig_resp_packets_ratio",
    "successful_connection_count", "failed_connection_count", "rejected_connection_count", "reset_connection_count",
    "connection_success_rate", "connection_failure_rate", "unique_conn_state_count",
    "http_request_count", "http_get_count", "http_post_count", "http_2xx_count", "http_4xx_count", "http_5xx_count",
    "http_error_rate", "unique_http_host_count", "unique_uri_count", "http_request_body_bytes", "http_response_body_bytes",
    "dns_query_count", "dns_success_count", "dns_error_count", "unique_dns_query_count", "unique_dns_answer_count", "dns_error_rate",
    "flow_interarrival_mean", "flow_interarrival_std", "flow_periodicity_score", "flow_burst_score",
]

# The model used by v0.3.1--v0.3.3 selected numeric columns rather than the
# declared profile.  This immutable list documents that accidental contract.
HISTORICAL_V031_BASELINE_FEATURES = [
    "window_index", "window_event_count", "window_has_events", "window_duration_seconds",
    *NETWORK_SENSOR_V0_3,
]
...
def get_feature_profile(name: str) -> list[str]:
    ...
    if name == "network_sensor_v0_4":
        return list(NETWORK_SENSOR_V0_4)
