...
def main():
 p=argparse.ArgumentParser(description='Сводный отчёт кампании.');p.add_argument('--output-root',default='lab/output');p.add_argument('--output',default='lab/output/campaigns/filin_v0_2_3/campaign_summary.md');a=p.parse_args();build_summary(Path(a.output_root),Path(a.output))
