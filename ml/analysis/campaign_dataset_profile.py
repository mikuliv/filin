...
def main():
 p=argparse.ArgumentParser(description='Профиль datasets кампании.');p.add_argument('--output-root',default='lab/output');p.add_argument('--json-report');a=p.parse_args();r=profile_campaign_datasets(Path(a.output_root));
