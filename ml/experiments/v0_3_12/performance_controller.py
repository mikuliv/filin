...
class ResourceMonitor:
    ...
    def summary(self):
        ...
        return {"sample_count":len(self.samples),"cpu_average_percent":statistics.mean(cpu),"cpu_median_percent":statistics.median(cpu),"cpu_p95_percent":sorted(cpu)[max(int(len(cpu)*.95)-1,0)],"peak_aggregate_rss_mb":max(rss),"swap_growth_mb":0.0,"gpu_acceleration_used":False,"raw_trace_tracked":False}
