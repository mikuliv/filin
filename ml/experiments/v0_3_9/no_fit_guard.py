"""Запрет всех обучающих операций во frozen validation v0.3.9."""
from __future__ import annotations
from contextlib import ExitStack
from unittest.mock import patch

BLOCKED=("fit","fit_transform","partial_fit","calibrate","optimize","search","select_features","set_params","train","tune","conformal_fit","support_fit","select_threshold","decision_grid_evaluate","lifecycle_tune")
class NoFitGuard:
    ...
    def report(self):return {"status":"passed","method_call_counts":self.counts,"fit_call_count":self.counts["fit"],"partial_fit_call_count":self.counts["partial_fit"],"calibration_performed_on_validation":False,"conformal_tuning_on_validation":False,"support_tuning_on_validation":False,"decision_tuning_on_validation":False,"lifecycle_tuning_on_validation":False,"model_refit_on_validation":False}
