"""Построение фиксированных grouped OOF HGB/HGB predictions v0.3.9."""
...
from pipeline import CONTROL_PROFILE,build_feature_frame,oof_base,write_json,sha256_json
def main():
 ...
 rows,X=build_feature_frame(pd.concat(frames,ignore_index=True),CONTROL_PROFILE);oof=oof_base(rows,X,"hist_gradient_boosting","hist_gradient_boosting")
