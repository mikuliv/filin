...
=======
Русскоязычная точка входа

Новые читатели начинают с [обзора проекта](01_Обзор_проекта.md), затем переходят к [архитектуре](02_Архитектура.md). Составные темы вынесены в отдельные документы: [сетевая обработка](03_Обработка_сетевого_трафика.md), [признаки](04_Построение_признаков.md), [машинное обучение](05_Машинное_обучение.md), [независимая валидация](06_Независимая_сетевая_валидация.md), [кампания](07_Научная_кампания.md), [сценарии](08_Сценарии_и_генераторы.md), [среда](09_Среда_исполнения.md), [проверки](10_Предварительные_проверки.md), [журнал](11_Журнал_кампании.md), [сопоставление и сокрытие](12_Сопоставление_и_сокрытие_данных.md), [ошибки](13_Повторные_попытки_и_ошибки.md), [восстановление](14_Восстановление_после_сбоев.md), [форматы](15_Форматы_данных.md), [Docker](16_Docker_инфраструктура.md), [тестирование](17_Тестирование.md), [установка](18_Установка_и_настройка.md), [история пакетов](19_История_научных_пакетов.md) и [текущее состояние](20_Текущее_состояние_разработки.md).

Исторические отчёты, контракты и machine-readable-файлы ниже сохранены как источники фактов. Их кодовые идентификаторы, контрольные суммы и научные результаты не переводятся и не переписываются.

## Статус
>>>>>>> 4baf747 (Полностью переработана русскоязычная документация проекта)
