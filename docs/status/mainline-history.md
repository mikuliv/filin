...
| Текущий candidate | `v0.3.15.4–v0.3.15.5.1` | создан `v03154`, scientific holdout и compatible runtime пройдены | внешняя validation отсутствует |
...
Stage-specific reports доступны через [индекс](../reports/index.md).
