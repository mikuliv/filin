...
Следующий допустимый шаг этой линии — только v0.4.2: формирование и проверка
нескольких конкурирующих гипотез на основании временных и структурных отношений.
