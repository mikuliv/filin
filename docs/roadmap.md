...
Отдельная v0.4.x ветка может исследовать:

- evidence reconstruction;
- incident hypothesis layer;
- grounded incident cards;
- optional constrained renderer.

Эти направления не являются current capabilities и не обязаны автоматически
следовать сразу после v0.3.19. Их protocol, data scope и readiness должны быть
утверждены отдельно.
