...
- токен консоли не превращает локальный узел в публичную службу;
- база данных среды выполнения не включается в зафиксированный комплект автоматически;
- внешняя сторона получает только согласованный пакет и описание области применимости.

## Не являющиеся доверием признаки

Подпись интерфейса, имя гипотезы, позиция на временной шкале и графическое соседство не
создают доказательную силу. Она определяется только источниками, контрактами и
зафиксированными правилами оценки.
