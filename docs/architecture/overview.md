...
Линия фиксирует происхождение кандидата, научные проверки, локальный среда выполнения,
...
цикл. Линия не меняет candidate артефакт, preprocessing, calibration, conformal
policy или Контракт события.
...
подтверждающие материалы и не изменяют source комплект или семантическая контрольная сумма.
...
- консоль не является серверная часть или SIEM;
