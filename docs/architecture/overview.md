...
Линия фиксирует происхождение кандидата, научные проверки, локальную среду выполнения,
...
цикл. Линия не меняет артефакт кандидата, предварительную обработку, калибровку,
conformal-политику или контракт события.
...
подтверждающими материалами и не изменяют исходный комплект или его семантическую
контрольную сумму.
...
- консоль не является серверной частью или SIEM;
