...
Отрицательный результат является частью доказательной истории. Он показывает,
какой критерий не выполнен и почему следующий этап был ограничен; удаление такого
результата сделало бы историю проекта невоспроизводимой.
