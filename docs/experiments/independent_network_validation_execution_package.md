# Исторический execution package независимой сетевой проверки

> Эта страница описывает ранний пакет v1. Последним официальным является v4;
> его ID, digest и отличие текущего runtime собраны в [истории пакетов](../research/phase1-execution-package-history.md).
