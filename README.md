...
| Лабораторная `v0.4.x` | `v0.4.7` | с разделением ролей слепая проверка пройдена; предложение кандидата получил `failed_validation` | Независимая человеческая проверка; `v0.4.8` запрещён |
