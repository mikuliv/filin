...
Он остаётся только проверяемым планом: локальные OCI-образы ещё не подтверждены
двойной воспроизводимой сборкой, рабочее дерево не зафиксировано. Научный корпус и
внешний результат ожидаемо отсутствуют до эксперимента и потребуются для последующего
scientific pass. Подробности приведены в [обзоре готовности freeze-candidate](docs/experiments/independent_network_validation_freeze_review.md).
