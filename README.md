...
> Лабораторная линия: v0.4.7.2 завершён. Новое предложение `proposal:v0472:f02d06231e65df6f` допущено только к подготовке новой слепой проверки v0.4.7.3; действующий кандидат не изменён, v0.4.8 запрещён. Основная линия по-прежнему ожидает v0.3.19.
...
| Лабораторная `v0.4.x` | `v0.4.7.1` | Все шесть провалов v0.4.7 разобраны; отрицательный результат сохранён | `v0.4.7.2`: новое корректирующее предложение; `v0.4.8` запрещён |
