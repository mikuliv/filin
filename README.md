...
| Лабораторная `v0.4.x` | `v0.4.6` | Воспроизводимое предложение лабораторного кандидата и ручной admission | `v0.4.7`: подготовка отдельного frozen validation protocol |
