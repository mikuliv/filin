...
from .common import ROOT, canonical_sha256, finish, parser
...
def validate(root=ROOT):
 ...
 for path,expected in EXPECTED.items():
  if (root/path).is_file() and canonical_sha256(root,path)!=expected:errors.append({"code":"official_license_text_modified","path":path})
