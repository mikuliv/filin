...
from .common import ROOT,canonical_sha256,dump,load,tracked
...
def positives()->list[dict]:
    ...
    checks=[
      ...
      ("mpl_exact",canonical_sha256(ROOT,"LICENSE")=="3f3d9e0024b1921b067d6f7f88deb4a60cbe7a78e76c64e3f1d7fc3b779b9d04"),
      ("cc_exact",canonical_sha256(ROOT,"LICENSES/CC-BY-4.0.txt")=="9ba9550ad48438d0836ddab3da480b3b69ffa0aac7b7878b5a0039e7ab429411"),
