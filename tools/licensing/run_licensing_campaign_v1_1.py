...
def positive_scenarios() -> list[dict]:
    ...
    checks += [
        ...
        ("protected_count", len(protected_before) == 833),
...
NEGATIVE_RULES = {
    ...
    "v045_changed": ("next_v045", lambda v: v != "v0.4.5"),
