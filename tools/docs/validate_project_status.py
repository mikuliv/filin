...
def validate() -> dict:
    ...
    expected = {
        "current_completed_stage": "v0.3.15.5.1", "current_candidate": "v03154:65a3dd912d845bc1",
    ...
    if policy153_path.is_file():
        ...
        if status.get("next_allowed_stage") != "v0.3.16": errors.append("next_stage_policy_mismatch")
