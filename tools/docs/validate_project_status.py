...
REQUIRED = CORE_DOCS + [
    ...
    ROOT / "docs/experiments/v0_3_18.md",
    ...
    ROOT / "ml/reports/v0_3_15_4/v0_3_15_4_policy_result.json",
    ROOT / "ml/reports/v0_3_15_5/v0_3_15_5_policy_result.json",
    ...
    ROOT / "ml/reports/v0_3_18/v0_3_18_policy_result.json",
]
...
def validate() -> dict:
    ...
    expected = {
        "current_completed_stage": "v0.3.18", "current_candidate": "v03154:65a3dd912d845bc1",
    ...
    if policy_path.is_file():
        ...
        latest_policy_path = ROOT / "ml/reports/v0_3_15_5_1/v0_3_15_5_1_policy_result.json"
        latest_passed = latest_policy_path.is_file() and json.loads(latest_policy_path.read_text(encoding="utf-8")).get("candidate_ready_for_v0_3_16_staging_connector_readiness")
        if not policy.get("v03152_prospective_runtime_trial_passed") and not latest_passed and status.get("blocked_stage") != "v0.3.16": errors.append("negative_trial_must_block_v0316")
    ...
    if policy153_path.is_file():
        ...
        latest318 = ROOT / "ml/reports/v0_3_18/v0_3_18_policy_result.json"
        if latest318.is_file() and json.loads(latest318.read_text(encoding="utf-8")).get("candidate_ready_for_v0_3_19_external_package_review"):
            expected_next = "v0.3.19"
        elif latest3171.is_file() and json.loads(latest3171.read_text(encoding="utf-8")).get("candidate_ready_for_v0_3_18_external_review_and_trial_design"):
    ...
    if "v0.3.15.4" not in versions: errors.append("v03154_stage_missing")
    if "v0.3.15.5" not in versions: errors.append("v03155_stage_missing")
    ...
    if "v0.3.18" not in versions: errors.append("v0318_stage_missing")
