...
def validate(root: Path) -> list[str]:
    ...
    failures = []
    expected = {"current_completed_stage": "v0.3.15.5.1", "current_candidate": "v03154:65a3dd912d845bc1", "latest_independent_model_holdout": "v0.3.15.5", "latest_runtime_trial": "v0.3.15.5.1", "next_allowed_stage": "v0.3.16"}
