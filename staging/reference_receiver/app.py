...
from staging.storage import ReceiverStore
...
def main() -> int:
    ...
    instance = os.environ.get("RECEIVER_INSTANCE_ID", "receiver_v0316_local")
    store = ReceiverStore(args.db, instance)
    ...
    serve(args.host, args.port, context, {"/reference-receiver/v1/event-batches": receive}, lambda: store.count() >= 0 and args.db.exists())
    return 0
