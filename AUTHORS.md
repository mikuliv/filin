...
Идентификаторы `mikuliv <ruslan.pockatilov@gmail.com>` и `mikuliv <64185192+mikuliv@users.noreply.github.com>` сопоставлены с одним лицом по устойчивому идентификатору GitHub и подтверждённой конфигурации этапа. `GitHub <noreply@github.com>` встречается только как техническая учётная запись, выполнившая коммит, и не считается отдельным автором.
